...
>
  ...
  <div className="relative z-20 flex items-center justify-center h-full px-4">
    <div className="max-w-5xl mx-auto text-center transition-all duration-1000 ${'opacity-100 translate-y-0">
      <h1 className="text-4xl md:text-6xl font-black text-white mb-4 leading-snug drop-shadow-lg">
        Busy Bee
        <br />
        <span className="text-yellow-400">Residential Services</span>
      </h1>
      <p className="text-base md:text-md text-gray-200 mb-6 font-light mx-auto max-w-3xl drop-shadow-md">
      ...
      {/* Services Section */}
      <section className="bg-[#fff6e8] relative">
